...
class OSINT_Plus:
    def __init__(self):
        self.tool_list = [Nmap(), HIBP(), AbuseIPDB(), DirBuster(), ZoomEye(), Hunter()]
    ...
    def starting_menu(self):
        os.system("clear")
        print("""Welcome to OSINT+\n
Remember this This OSINT tool is intended for ethical, legal, and authorized use in controlled environments.
You must obtain explicit permission before gathering any information and comply with all relevant laws and regulations.
Unauthorized or malicious use is strictly prohibited and may result in legal consequences.
By using this tool, you agree to adhere to these guidelines and take full responsibility for your actions.
The developers are not liable for any misuse or illegal activities conducted with this tool.
              """)
        options = ["Start", "Exit"]
